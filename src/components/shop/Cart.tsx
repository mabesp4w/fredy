...
const Cart = () => {
  ...
  const MIDTRANS_CLIENT_KEY = NEXT_PUBLIC_MIDTRANS_CLIENT_KEY;
  ...
  return (
    <>
      <div className="overflow-hidden relative">
        ...
        <div
          id="sidebar-overlay"
          className={`fixed inset-0 bg-black bg-opacity-50 z-10 transition-opacity  h-screen ${
            isOpen
        ...
        >
          ...
          >
            <div className="p-4 w-[20rem] text-black">
              ...
              {dtCarts?.data && dtCarts.data.length > 0 && (
                <div className="flex flex-col gap-y-4">
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="flex flex-col">
                            <span>
                              {cart.product_variant.product.product_nm}
                            </span>
                            <span className="text-sm">
                              x {cart.quantity}-
                              {cart.product_variant.variant_nm}
                            </span>
                  ...
                  {/* pembayaran */}
                  <div className="self-center w-fit mt-4">
                    <button
      ...
      <Question
        ...
        MIDTRANS_CLIENT_KEY={MIDTRANS_CLIENT_KEY as string}
        carts={dtCarts.data}
        user={dtUser as any}
      />
    </>
