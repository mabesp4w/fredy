...
type Store = {
  ...
  setShippingCosts: ({ page, limit, search, sortby, order }: Props) => Promise<{
    status: string;
    data?: {};
    error?: {};
  }>;
      ...
      try {
        ...
        set((prevState) => ({
          dtShippingCosts: {
            ...
            data: [res.data.data, ...prevState.dtShippingCosts.data],
          },
        }));
        return {
      ...
      try {
        ...
        set((prevState) => ({
          dtShippingCosts: {
            last_page: prevState.dtShippingCosts.last_page,
            current_page: prevState.dtShippingCosts.current_page,
            data: prevState.dtShippingCosts.data.map((item: any) => {
              if (item.id === id) {
                return {
                  ...item,
                  ...response.data.data,
